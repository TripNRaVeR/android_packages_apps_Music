...
import static com.andrew.music.utils.PreferenceUtils.RECENT_LAYOUT;
...
import com.andrew.music.adapters.AlbumAdapter;
import com.andrew.music.cache.ImageFetcher;
import com.andrew.music.loaders.RecentLoader;
...
public class RecentFragment extends Fragment implements LoaderCallbacks<List<Album>>,
    ...
    private void initGridView() {
        ...
        if (MusicAppUtils.isLandscape(getActivity())) {
            if (isDetailedLayout()) {
