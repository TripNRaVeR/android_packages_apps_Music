...
import static com.andrew.music.Config.MIME_TYPE;
...
import com.andrew.music.format.Capitalize;
import com.andrew.music.loaders.AsyncHandler;
import com.andrew.music.loaders.LastAddedLoader;
import com.andrew.music.loaders.SearchLoader;
...
public class ShortcutActivity extends FragmentActivity implements ServiceConnection {
    ...
    private final LoaderCallbacks<List<Song>> mSongAlbumArtistQuery = new LoaderCallbacks<List<Song>>() {
        ...
        public void onLoadFinished(final Loader<List<Song>> loader, final List<Song> data) {
            ...
            // What's about to happen is similar to the above process. Music
            // runs a
