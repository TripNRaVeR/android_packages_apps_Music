...
import com.andrew.music.format.PrefixHighlighter;
import com.andrew.music.recycler.RecycleHolder;
import com.andrew.music.ui.MusicHolder;
...
/**
 * Provides the search interface for Music.
 * 
...
public class SearchActivity extends Activity implements LoaderCallbacks<Cursor>,
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if (MusicAppUtils.isLandscape(this)) {
    ...
    private static final class SearchAdapter extends CursorAdapter {
        ...
        public SearchAdapter(final Activity context) {
            ...
            mImageFetcher = MusicAppUtils.getImageFetcher(context);
