...
package com.andrew.music.widgets;
...
import com.andrew.music.widgets.ColorPickerView.OnColorChangedListener;
...
public class ColorSchemeDialog extends AlertDialog implements
    ...
    public void onAttachedToWindow() {
        ...
        MusicAppUtils.removeHardwareAccelerationSupport(mColorPicker);
    }

    /*
     * (non-Javadoc)
     * @see com.andrew.music.widgets.ColorPickerView.OnColorChangedListener#
     * onColorChanged(int)
     */
    @Override
     ...
     * @return A new color from Music's resources.
     */
