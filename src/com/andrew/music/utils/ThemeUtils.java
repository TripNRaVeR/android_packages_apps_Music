...
package com.andrew.music.utils;
...
/**
 * In order to implement the theme chooser for Music, this class returns a
 ...
 * identifiers are the same as all of Music's resources a little less code is
...
public class ThemeUtils {
    ...
    /**
     * Used to searc the "Apps" section of the Play Store for "Music Themes".
     */
     ...
     */
    public static final String MUSIC_PACKAGE = "com.andrew.music";
     ...
     */
    private static String sMusicSearch;
    ...
    public ThemeUtils(final Context context) {
        ...
        sMusicSearch = context.getString(R.string.music_themes_shop_key);
        // Get the preferences
        ...
        try {
            ...
            // Music's.
            setThemePackageName(MUSIC_PACKAGE);
        }
    ...
    public void setThemePackageName(final String packageName) {
        MusicAppUtils.execute(false, new AsyncTask<Void, Void, Void>() {
            @Override
    ...
    public final String getThemePackageName() {
        return mPreferences.getString(PACKAGE_NAME, MUSIC_PACKAGE);
    }
    ...
    public boolean isActionBarDark() {
        return MusicAppUtils.isColorDark(getColor("action_bar"));
    }
    ...
    public void setOverflowStyle(final Activity app) {
        if (isActionBarDark()) {
            app.setTheme(R.style.Music_Theme_Dark);
        } else {
            app.setTheme(R.style.Music_Theme_Light);
        }
    }
    ...
    /**
     * Used to search the Play Store for "Music Themes".
     * 
     * @param context The {@link Context} to use.
     */
    public void shopFor(final Context context) {
        final Intent shopIntent = new Intent(Intent.ACTION_VIEW);
        shopIntent.setData(Uri.parse(String.format(SEARCH_URI, Uri.encode(sMusicSearch))));
