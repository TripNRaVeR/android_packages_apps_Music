...
import com.andrew.music.widgets.ColorPickerView;
import com.andrew.music.widgets.ColorSchemeDialog;
 ...
 */
public final class MusicAppUtils {
    ...
    public static void createShortcutIntent(final String displayName, final String artistName,
        ...
        try {
            ...
            Log.e("MusicAppUtils", "createShortcutIntent", e);
            AppMsg.makeText(
                    context,
